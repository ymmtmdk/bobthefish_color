...
function bobthefish_color
  ...
  set -l grey     cccccc 999999 555555
  set -l white    ffffff
  set -l black    000000
  ...
  set -g __color_repo_work_tree           $green[1] $white --bold
  set -g __color_repo_dirty               $red[2] $white
  set -g __color_repo_staged              $orange[1] $orange[3]

  set -g __color_vi_mode_default          $grey[2] $grey[3] --bold
  set -g __color_vi_mode_insert           $green[2] $grey[3] --bold
